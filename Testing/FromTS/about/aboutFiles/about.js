...
window.Typekit.config = {
    "f": "//use.edgefonts.net/c/894afd/1w;montserrat,2,2cm5Ph:W:n4;source-sans-pro,2,2cm8F1:W:n2/{format}{/extras*}",
    "fi": [16353, 17275],
    "fn": ["montserrat", ["n4"], "source-sans-pro", ["n2"]],
    "ht": "tk",
    "js": "1.14.9",
    "p": "//p.typekit.net/p.gif?s=4&h={host}&f=16353.17275&app={app}&_={_}",
    "ps": 4
};;
